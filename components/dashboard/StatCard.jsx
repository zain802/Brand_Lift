...
const StatCard = ({ title = "", value = "", subValue = false, icon = null }) => {
    return (
        <div className="bg-white p-6 md:p-8 shadow-lg rounded-[15px] flex flex-col justify-between h-full transition-all duration-300 hover:bg-gradient-to-br hover:from-[#2e1065] hover:via-[#4c1d95] hover:to-[#7c3aed] group hover:shadow-xl hover:-translate-y-1">
            <div>
